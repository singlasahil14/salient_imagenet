...
+ Load the **Salient ImageNet dataset** using [this link](https://umd.box.com/s/eyji8leh2lemhbxovgny9ywc9is53ibr). Next unzip the folder using: ```unzip salient_imagenet_dataset.zip```
