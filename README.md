...
+ NOTE: Some ImageNet versions require the ```meta.bin``` file to be placed in the folder ending with ```ILSVRC2012/```. For this purpose, you can use the ```meta.bin``` file provided in this repo. 
